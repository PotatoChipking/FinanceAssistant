...
function App() {
  ...
  const repoUrl = 'https://github.com/PotatoChipking/finance'
  ...
  useEffect(() => {
    ...
    fetchAPI<any>('/settings/update-check')
      .then((res) => {
        ...
        setUpgradeInfo({ latest, url: String(res?.release_url || 'https://github.com/PotatoChipking/finance/releases') })
        setUpgradeOpen(true)
      })
      .catch(() => {})
  }, [version])
        ...
        <header className="card px-4 md:px-5">
          <div className="h-14 flex items-center justify-between">
            ...
            <NavLink to="/" className="flex items-center gap-2.5 group">
              ...
              <span className="text-[15px] font-bold text-foreground">panwatcher</span>
        ...
        <header className="card px-4">
          <div className="h-12 flex items-center justify-between">
            <NavLink to="/" className="flex items-center gap-2 group">
              ...
              <span className="text-[14px] font-bold text-foreground">panwatcher</span>
      ...
      <Dialog open={upgradeOpen} onOpenChange={setUpgradeOpen}>
        <DialogContent className="max-w-md">
          ...
          <div className="flex items-center justify-end gap-2">
            ...
            <Button
              onClick={() => {
                const url = upgradeInfo?.url || 'https://github.com/PotatoChipking/finance/releases'
